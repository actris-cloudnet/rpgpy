...
METADATA = {
    ...
    'ProgName': Meta(
        name='program_name',
        long_name='Program Name'),
    'CustName': Meta(
        name='customer_name',
        long_name='Customer Name'),
    'Freq': Meta(
        name='radar_frequency',
    ...
    'RAlts': Meta(
        name='range_layers',
        long_name='Range Layers'),
    'TAlts': Meta(
        name='temperature_layers',
        long_name='Temperature Layers'),
    'HAlts': Meta(
        name='humidity_layers',
        long_name='Humidity Layers'),
    'Fr': Meta(
        name='range_factors',
        long_name='Range Factors'),
    'SpecN': Meta(
    ...
    'ChirpBWFr': Meta(
        ...
        long_name='Chirp Bandwidth',
        units='MHz'),
    'FFTStartInd': Meta(
        name='fft_start_index',
        long_name='FFT Start Index'),
    'FFTStopInd': Meta(
        name='fft_stop_index',
        long_name='FFT Stop Index'),
    'ChirpFFTNo': Meta(
        name='n_chirp_fft',
    ...
    'MSec': Meta(
        name='time_ms',
        long_name='Milliseconds of Sample',
        units='ms'),
    'QF': Meta(
        name='quality_flag',
    ...
    'EnvTemp': Meta(
        name='temperature',
        long_name='Environment Temperature',
        units='K'),
    'BaroP': Meta(
        name='pressure',
